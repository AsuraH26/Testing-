...
private:
	...
	void SecureSend(
		NET_Packet& P, u32 dwFlags = DPNSEND_GUARANTEED, u32 dwTimeout = 0);
...
public:
	...
	void g_cl_Spawn(
		LPCSTR name, u8 rp, u16 flags, Fvector pos); // only ask server
	...
	void GetGameDateTime(u32& year, u32& month, u32& day, u32& hours, u32& mins,
		u32& secs, u32& milisecs);
	...
	virtual void SetEnvironmentGameTimeFactor(
...
public:
	...
	bool IsServer();
	bool IsClient();
	CSE_Abstract* spawn_item(LPCSTR section, const Fvector& position,
		u32 level_vertex_id, u16 parent_id, bool return_item = false);
	virtual void SpawnItem(LPCSTR section, const Fvector& position,
		u32 level_vertex_id, u16 parent_id) override;
